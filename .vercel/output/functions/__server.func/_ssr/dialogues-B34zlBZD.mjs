...
import { A as upsertCsv, j as usePdaStore, k as suggestionsFor, r as Button, t as AppHeader } from "./app-header-DGS9uiUo.mjs";
import { i as Textarea, n as Input, r as Label, t as BbText } from "./input-RevLgvVB.mjs";
import { S as writeLocalization, _ as reindex, a as catalogText, b as uniqueDialogueName, c as dialogueStrings, g as parseDialogueDoc, i as blankFunction, l as gotoTarget, m as mergeForeignDialogues, n as VAR_TYPES, o as dialogueDocFor, p as looksLikeKey, r as blankDialogue, s as dialogueGroup, t as SNIPPETS, u as isGotoReset, v as resolveDialogueText, x as writeDialogues, y as setGoto } from "./library-COrpIse4.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/dialogues-B34zlBZD.js
...
function DialogueEditor() {
	...
	const saveLoca = (table) => setCatalogText(catalogText(catalog, "dialoguesCsv") ? "dialoguesCsv" : "localization", writeLocalization(table), catalogText(catalog, "dialoguesCsv")?.path || catalogText(catalog, "localization")?.path || "Dialogues.csv");
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
