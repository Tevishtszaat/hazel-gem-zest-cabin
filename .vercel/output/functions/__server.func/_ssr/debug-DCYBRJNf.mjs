...
import { M as usePdaStore, N as useProblems, S as problemIgnoreKey, r as Button, t as AppHeader } from "./button-DWalkn6S.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/debug-DCYBRJNf.js
...
function DebugPage() {
	...
	const [showLength, setShowLength] = (0, import_react.useState)(false);
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
						...
						children: ["Catch empty rows, unknown names, and missing pictures. Wrap and character-count warnings stay hidden unless you turn them on. Ignore parks an issue so it stops counting.", busy ? " Rechecking in the background…" : ""]
					})]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
							className: "flex h-8 items-center gap-2 px-2 text-xs text-muted",
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						filter === "ignored" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
							size: "sm",
							variant: "secondary",
				...
				!visible.length ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					...
					children: raw.length ? "Nothing matches this filter." : "No issues. Structure looks exportable."
				}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
					className: "space-y-2",
					children: visible.slice(0, 400).map((issue) => {
									...
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											...
											children: [
												...
												ignored ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
													className: "text-xs text-subtle",
													children: "ignored"
												}) : null
											]
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											...
											children: [
												issue.fixes.map((fix) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
												...
												ignored ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
												...
												issue.id ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
													className: "h-7 rounded-sm px-2 text-xs text-muted hover:text-fg",
													onClick: () => open(issue),
													children: "Jump"
												}) : null
